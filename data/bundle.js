...
var app = (function () {
    ...
    function create_if_block_2$2(ctx) {
    	...
    	return {
    		c() {
    			button = element("button");
    			button.innerHTML = `<div class="recordCenter svelte-6zeimt"></div>`;
    			attr(button, "class", "recordBtn svelte-6zeimt");
    		},
    		m(target, anchor) {
    ...
    // (135:8) {#if !isRecording && !recorededVideo}
    function create_if_block_1$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button, "class", "flipBtn svelte-6zeimt");
    		},
    		m(target, anchor) {
    			insert(target, button, anchor);
    ...
    function create_if_block$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			button0.innerHTML = `<h3 class="svelte-6zeimt">Retake</h3>`;
    			t1 = space();
    			button1 = element("button");
    			button1.innerHTML = `<h3 style="color: #484848;" class="svelte-6zeimt">Save</h3>`;
    			attr(button0, "class", "redBtn svelte-6zeimt");
    			attr(button1, "class", "saveBtn svelte-6zeimt");
    			attr(div, "class", "bottomBtns svelte-6zeimt");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    			append(div, button0);
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button, "class", "backBtn svelte-6zeimt");
    			attr(h3, "class", "svelte-6zeimt");
    			video.muted = true;
    			video.autoplay = true;
    			video.playsInline = true;
    			video.loop = true;
    			attr(video, "class", "svelte-6zeimt");
    			attr(div0, "class", "videoMask svelte-6zeimt");
    			attr(div1, "class", "vidHolder svelte-6zeimt");
    			attr(div2, "class", "center svelte-6zeimt");
    		},
    		m(target, anchor) {
